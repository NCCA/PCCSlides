...
faces=[
    ...
    [5, 1, 2], [6, 2, 2], [7, 3, 2],[8, 4, 2], # front face
    [1, 1, 5], [5, 2, 5], [8, 3, 5],[4, 4, 5], # left face
    [2, 1, 6], [6, 2, 6], [7, 3, 6],[3, 4, 6], # right face
    [4, 1, 4], [8, 2, 4], [7, 3, 4],[3, 4, 4], # top face
    [1, 1, 3], [2, 2, 3], [6, 3, 3],[5, 4, 3]  # bottom face
]
